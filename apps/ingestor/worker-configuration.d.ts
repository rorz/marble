/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7c6d5e3b5886cf6de9f4d9b06ea3bf41)
// Runtime types generated with workerd@1.20260405.1 2026-04-12 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		SOURCE_INGEST_QUEUE: Queue;
		SUPABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_SERVICE_ROLE_KEY" | "MARBLE_EXECUTOR_URL">> {}
}
