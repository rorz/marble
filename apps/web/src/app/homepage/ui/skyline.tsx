...
/**
 * Marketing skyline — the program-model thesis rendered as a city
 * silhouette. Each tower is a Marble column; each window is a cell.
 *
 ...
 *   - red     = error (rare)
 *
 * The whole skyline tilts back with CSS perspective for a "looking up
...
export function MarketingSkyscraper({
  ...
  return (
    ...
    >
      ...
      {/* Foundation tag */}
      <div className="-mt-px relative z-10 flex items-center justify-between gap-1 rounded-b-xs border-2 border-taupe-100/15 border-t-0 bg-taupe-800/90 px-2 py-1">
