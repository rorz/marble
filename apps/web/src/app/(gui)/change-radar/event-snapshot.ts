...
export const formatRadarRelativeTime = (value: string) => {
...
export const getEventSnapshot = (event: EventRow) => {
...
export const upsertRadarEvent = (current: EventRow[], nextEvent: EventRow) => {
  return [
    nextEvent,
